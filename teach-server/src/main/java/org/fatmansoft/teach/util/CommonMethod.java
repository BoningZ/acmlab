...
public class CommonMethod {
    ...
    public static Map<String, Object> objectToMap(Object obj) {
        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            if(value!=null&&(value.getClass().equals(ContestType.class)||value.getClass().equals(Contest.class)))value=value.toString();
            if(value!=null&&value.getClass().equals(Student.class))continue;
